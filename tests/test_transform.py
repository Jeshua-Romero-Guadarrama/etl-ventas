...
Sigo la misma idea que en la Tarea 1: pruebas pequenas, con un solo motivo de
fallo cada una, para que cuando una rompa quede claro que se rompio.
"""
...
# ---------------------------------------------------------------------------
# Pruebas de normalizar_fecha (reutilizada de la Tarea 1)
# ---------------------------------------------------------------------------
