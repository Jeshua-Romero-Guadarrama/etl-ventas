...
Lo dejo como CLI para que sea facil de correr a mano, dentro de Docker o desde
un agente de Jenkins, siempre con el mismo comando. La logica de negocio NO vive
aqui: este archivo solo coordina las etapas e imprime un pequeno reporte.

A diferencia de una version minima, dejo '--input' y '--output' como opcionales
con valores por defecto: asi el contenedor puede ejecutar 'python run_pipeline.py'
sin argumentos, pero tambien puedo apuntar a otros archivos cuando lo necesite.
